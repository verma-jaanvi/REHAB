  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at top right, #006B7D 0%, transparent 50%), radial-gradient(circle at bottom left, #7ED6DF 0%, transparent 50%)",
        }}
      />
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">
                  #401, Joyash Apartments, CMC Enclave, Kondapur, Hyderabad,
                  India, Pincode - 500084
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} ReHax by Skavion Auto Private Limited. All rights reserved.
            </p>
