...
import rehaxImg from "./../assets/logo/ReHAX.png";
import tmImg from "./../assets/logo/TM.png";
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div style={{ position: "relative", display: "inline-block" }}>
              ...
              {/* Trademark as Superscript (Top Right) */}
              <img
                src={tmImg}
                alt="Trademark"
                style={{
          ...
          <div className="flex items-center gap-10">
            ...
            >
              ...
              >
                Solutions
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 ${showSolutionsDropdown ? "rotate-180" : ""}`}
                />
                {isSolutionPage && (
                  <div
                    className="absolute -bottom-1 left-0 right-0 h-0.5 rounded-full"
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-xs opacity-60">
                      Adult & Pediatric neurological care
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-xs opacity-60">
                      Musculoskeletal recovery solutions
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="text-xs opacity-60">
                      Communication & swallowing therapy
                    </div>
                  </button>
            ...
            <button
              ...
              style={{
                color: currentPage === "space-planner" ? "#006B7D" : "#6B7280",
              }}
            >
              3D Space Planner
              {currentPage === "space-planner" && (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #7ED6DF 0%, #006B7D 100%)",
                }}
              />
            </button>
          </div>
