...
import rehabFounderChallengeImg from "../../assets/image/homePage/rehabChallenge.png";
...
const heroSlides = [
  {
    ...
    description:
      "Interactive 3D planning tools to design your perfect rehab space",
    bgColor: "linear-gradient(135deg, #006B7D 0%, #0A4D5C 100%)",
    image:
      "https://images.unsplash.com/photo-1764314359427-6e685ce5b719?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaHlzaWNhbCUyMHRoZXJhcHklMjBlcXVpcG1lbnQlMjBleGVyY2lzZXxlbnwxfHx8fDE3NzAzMjQ0ODh8MA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    title: "Comprehensive Solutions",
    subtitle: "End-to-End Rehabilitation Services",
    description:
      "From planning to installation, we deliver complete turnkey solutions",
    bgColor: "linear-gradient(135deg, #5E60CE 0%, #4248A3 100%)",
    image:
      "https://images.unsplash.com/photo-1706777280252-5de52771cf13?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwdGVjaG5vbG9neSUyMGlubm92YXRpb258ZW58MXx8fHwxNzcwMzAxNzQ4fDA&ixlib=rb-4.1.0&q=80&w=1080",
  },
  {
    title: "Global Partnerships",
    subtitle: "Industry-Leading Technology",
    description:
      "Access cutting-edge equipment from world-renowned manufacturers",
    bgColor: "linear-gradient(135deg, #1E3A4C 0%, #0F1F2E 100%)",
    image:
      "https://images.unsplash.com/photo-1765222385062-11262da1ff2e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob3NwaXRhbCUyMHJlaGFiaWxpdGF0aW9uJTIwZmFjaWxpdHl8ZW58MXx8fHwxNzcwMzI0NDkwfDA&ixlib=rb-4.1.0&q=80&w=1080",
  },
];
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div
              className="absolute inset-0"
              style={{
                background: heroSlides[currentSlide].bgColor,
                opacity: 0.92,
              }}
            />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.p
                ...
                style={{ color: "#006B7D" }}
              >
                ✨ Rehax eliminates these frustrations with our comprehensive
                turnkey solution
              </motion.p>
            </div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(94, 96, 206, 0.1) 0%, rgba(126, 214, 223, 0.1) 100%)",
                  }}
                />
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold" style={{ color: "#1E3A4C" }}>
                      Trusted Solution
                    </div>
