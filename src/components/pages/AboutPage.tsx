...
import ajayImg from "../../assets/image/ajay-patel-img.jpg";
import srinivasImg from "../../assets/image/srinivas-img.jpg";
import ourMissionImg from "../../assets/image/aboutPage/ourMissionImg.png";
import ourVisionImg from "../../assets/image/aboutPage/ourVisionImg.png";
import ourCoreValuesImg from "../../assets/image/aboutPage/ourCoreValuesImg.png";

export function AboutPage() {
  const timeline = [
    {
      year: "2003",
      event: "Founded Rehax with vision for rehabilitation excellence",
    },
    {
      year: "2008",
      event: "Expanded to 50+ partner hospitals across South India",
    },
    ...
    {
      year: "2024",
      event: "150+ hospitals, 500+ installations, 10+ global partners",
    },
  ];
  ...
  return (
    <div className="pt-16">
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #006B7D 0%, #004A58 100%)",
        }}
      >
        ...
        <div className="max-w-5xl mx-auto text-center text-white relative z-10">
          ...
          >
            Pioneering rehabilitation excellence through innovation, expertise,
            and unwavering commitment to healthcare
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-6 leading-relaxed font-medium">
                To empower healthcare providers with cutting-edge rehabilitation
                technology and comprehensive support, enabling them to deliver
                exceptional patient care and outcomes.
              </p>

              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                We are dedicated to transforming the rehabilitation landscape by
                providing innovative solutions that bridge the gap between
                advanced technology and compassionate care. Our mission drives
                us to continuously elevate standards and create meaningful
                impact in every facility we serve.
              </p>
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(94, 96, 206, 0.1) 0%, rgba(0, 107, 125, 0.1) 100%)",
                  }}
                />
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(0, 107, 125, 0.1) 0%, rgba(94, 96, 206, 0.1) 100%)",
                  }}
                />
              </div>
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-6 leading-relaxed font-medium">
                To be the most trusted partner in rehabilitation excellence
                across South Asia, recognized for innovation, quality, and
                transformative impact on patient lives.
              </p>

              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                We envision a future where every rehabilitation center has
                access to world-class technology and expertise, where patient
                outcomes are maximized through innovation, and where healthcare
                professionals are empowered with the best tools and training to
                make a difference.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    <span className="font-medium" style={{ color: "#1E3A4C" }}>
                      {item.label}
                    </span>
                    <span
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Our values define who we are and shape everything we do, from how
              we serve our partners to how we innovate for the future
            </p>
          </div>
          ...
          >
            <div className="relative h-80">
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to right, #182E40 0%, #0C172080 50%, #00000000 100%)",
                  border: "none",
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="p-12 text-white max-w-2xl">
                  ...
                  <p className="text-lg opacity-90">
                    ...
                    foundation of every project we undertake, every relationship
                    we build, and every innovation we pursue.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From our founding to becoming South India's leading rehabilitation
              solutions partner
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, #5E60CE 0%, #006B7D 50%, #7ED6DF 100%)",
              }}
            />
      ...
      <section className="py-24 px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Decades of combined experience in healthcare, technology, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              {
                name: "Mr. Ajay Patel",
                role: "Advisory Board, SEPAL",
                bio: "As the Pioneer of industrial manufacturing in UP - India, Mr Ajay Patel as the founder and promoter of Ray International and Radish Technologies, has brought several Electronic Giants like LG, Samsung other Global Players like Walmart to Indian shores for their manufacturing needs. Apart from delivering numerous technology products to 30+ countries, Mr Ajay Patel is also a key backer & mentor in several disruptive startups.",
                color: "#5E60CE",
                image: ajayImg,
              },
              {
                ...
                >
                  <div className="relative h-100 overflow-hidden">
                    <img
                      src={member.image}
                      alt={member.name}
                      className="w-full h-fit object-cover group-hover:scale-110 transition-transform duration-500"
                    />
                    <div
                      className="absolute inset-0"
                      style={{
                        background: `linear-gradient(to top, ${member.color}40 0%, transparent 50%)`,
                      }}
                    />
                  </div>
      ...
      <section className="py-24 px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our strength lies in our dedicated and passionate team of experts.
              With diverse backgrounds in rehabilitation, technology, and
              patient care, we are united by a common mission to deliver
              exceptional solutions and support.
            </p>
          </div>
          ...
          <div className="text-center">
            <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Each member brings invaluable experience and commitment, driving
              innovation and ensuring the highest standards of service for our
              partners and clients. Together, we're building the future of
              rehabilitation.
            </p>
          </div>
        </div>
      ...
      <section className="py-24 px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive capabilities spanning the entire rehabilitation
              technology spectrum
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h3 className="font-bold mb-2" style={{ color: "#1E3A4C" }}>
                  {item.title}
                </h3>
                <p className="text-sm text-gray-600 leading-relaxed">
                  {item.desc}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center text-white relative z-10">
          ...
          <p className="text-xl mb-10 opacity-90">
            Let's work together to create exceptional rehabilitation facilities
            that change lives
          </p>
          <button
